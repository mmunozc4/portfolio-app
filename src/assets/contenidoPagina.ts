export const mypuData = {
    banner: {
        bienvenida: 'BIENVENID@ A',
        nombre_empresa: 'MyPu.',
        eslogan: 'Impulsamos tus ideas',
    ...
    Estas experiencias previas nos permiten aportar a MyPu una base sólida de buenas prácticas, innovación y enfoque en la generación de valor real para nuestros clientes.`,
        skills_tecnologias: {
            Front: ['Angular', 'Django', 'React', 'Wordpress'],
            Back: ['FastApi', 'NodeJs', 'NextJs', 'Wordpress'],
            Lenguajes: ['Python', 'Java', 'Javascript', 'Typescript', 'HTML', 'Css'],
            Otros: ['Figma', 'Docker', 'Azure', 'PostgresSql', 'MySQL', 'SqlServer']
        },
        certificaciones: [
    ...
    contacto: {
        mensaje1: '¿Tienes una idea o proyecto?',
        mensaje2: 'En MyPu convertimos tus retos en soluciones digitales de impacto.',
        correo: 'contacto@mypu.com',
        redes: {
            linkedin: 'https://www.linkedin.com/company/mypu',
            github: 'https://github.com/mypu',
            instagram: 'https://instagram.com/mypu'
        }
    }
};
